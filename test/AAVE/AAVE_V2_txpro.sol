...
contract LiquidationOperator is IUniswapV2Callee, Test {
    ...
    address public Borrower_to_be_liquidated = 0x59CE4a2AC5bC3f5F225439B2993b86B42f6d3e9F; 
    ...
    function uniswapV2Call( 
        ...
        lending_pool.liquidationCall(address(WBTC), address(USDT), Borrower_to_be_liquidated, my_usdt_balance, false);
        ...
        WBTC.approve(address(sushiswapRouter02), type(uint256).max);
